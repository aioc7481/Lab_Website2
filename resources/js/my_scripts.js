...
function viewStudentStats(id, toggle){
			...
			if (id == 'student_status' && toggle == 1){
				...
				document.getElementById('student_status').style.height = 'initial';
				document.getElementById('grad_select').style.height = 'initial';
				document.getElementById('undergrad_select').style.height = 'initial';
			}
			if (id == 'undergrad_select' && toggle == 0) {
					document.getElementById('undergrad_select').style.visibility = 'hidden';
					document.getElementById('grad_select').style.visibility = 'visible';
					document.getElementById('grad_select').style.height = 'auto';
				}
			else if (id == 'undergrad_select' && toggle == 1) {
